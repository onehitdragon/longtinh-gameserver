 ...
 * 鲜花：增加 100 爱情值
 */
public class Flower extends SpecialGoods{
    /**
     * 构造
     *
     * @param _stackNums
     */
    public Flower(int _id, short _stackNums) {
    ...
    public boolean beUse(HeroPlayer _player, Object _target, int _location) {
        if(_player.spouse.trim().length()>0){
            ...
            if(other != null && other.isEnable()){
                _player.addLoverValue(LoverServiceImpl.ADD_LOVER_VALUE_FOR_FLOWER);
                other.addLoverValue(LoverServiceImpl.ADD_LOVER_VALUE_FOR_FLOWER);
    ...
    public ESpecialGoodsType getType() {
        return ESpecialGoodsType.FLOWER;
    }
